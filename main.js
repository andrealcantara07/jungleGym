...
class Pokemon {
  ...
  display(){
    ...
    img.src = this.sprite;
    let nameEl= document.getElementById("pokemonName");
    nameEl.innerHTML = this.name;
    let abilityEl= document.getElementById("pokemonAbility");
    abilityEl.innerHTML = "Ability: " + this.abilities;
    let attackEl= document.getElementById("pokemonAttack");
    attackEl.innerHTML= "Attack: " + this.attack;
    let defenseEl= document.getElementById("pokemonDefense");
    defenseEl.innerHTML= "Defense: " + this.defense;
    let hpEl= document.getElementById("pokemonHealth")
